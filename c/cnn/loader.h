...
public:
	...
	void load_libsvm_data(const char* pathToFile, uint32_t _numSamples, uint32_t _numFeatures, uint32_t _numClasses);
...
void loader::load_libsvm_data(const char* pathToFile, uint32_t _numSamples, uint32_t _numFeatures, uint32_t _numClasses) {
