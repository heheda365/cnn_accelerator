...
int main(int argc, char const *argv[])
{
    ...
    linear<LINEAR_0_IN_N, LINEAR_0_OUT_N>(linear_in, linear_0_out, linear_0_w, (uint8_t *) NULL);
    ...
    linear<LINEAR_1_IN_N, LINEAR_1_OUT_N>(linear_0_out, linear_1_out, linear_1_w, (uint8_t *) NULL);
